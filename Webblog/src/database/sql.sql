...
--CREATE TABLE IF NOT EXISTS postMVP1 (postid integer PRIMARY KEY, title TEXT NOT NULL, date TEXT NOT NULL);
--INSERT INTO postMVP1 (postid, title, date) VALUES (1, "Start of Projekt Pierixman", "Anno dazumal");
SELECT * FROM postMVP1;
